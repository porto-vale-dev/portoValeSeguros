    ...
    >
      <div className="container mx-auto flex h-20 items-center justify-between px-4 md:px-6">
        <Link href="/" className="flex items-center gap-2 font-bold">
          <Image src="/img/portoseguros_oficial.png" alt="Porto Vale Seguros Logo" width={150} height={40} />
        </Link>
              ...
              <div className="flex h-full flex-col">
                 <div className="flex items-center justify-between border-b p-4">
                    <Link href="/" className="flex items-center gap-2 font-bold" onClick={() => setIsMenuOpen(false)}>
                       <Image src="/img/portoseguros_oficial.png" alt="Porto Vale Seguros Logo" width={120} height={40} />
                    </Link>
